/*
  # Fix Technician Status Case Sensitivity

  ## Overview
  The get_sorted_technicians_for_store function was checking for 'Active' (uppercase)
  but the database has 'active' (lowercase), causing no employees to be returned.

  ## Issue
  - Function checked: e.status = 'Active'
  - Database has: status = 'active'
  - Result: No technicians shown in dropdown

  ## Fix
  - Use case-insensitive comparison with ILIKE or LOWER()
  - This ensures it works regardless of case in the database

  ## Testing
  After this fix, technicians should appear in the New Ticket dropdown.
*/
